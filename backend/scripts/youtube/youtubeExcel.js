...
const UPLOAD_LOG_FILE = path.resolve(
    __dirname,
    "../../generated/uploads/youtubeUploads.jsonl"
);

// --------------------------------
// Add YouTube Upload To JSONL
// --------------------------------
...
export async function addYouTubeUploadToExcel({
    ...
    const entry = {
        ...
        tutorialTitle: String(tutorialTitle || "").trim(),
